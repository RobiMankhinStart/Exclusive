              ...
              <div className="bg-white py-6 sm:py-8 px-4 sm:px-6 shadow sm:rounded-lg">
                ...
                >
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full flex justify-center py-2 sm:py-3 px-4 border border-transparent rounded-md shadow-sm text-sm sm:text-base font-medium text-white bg-[#DB4444] hover:bg-[#c33a3a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#DB4444] transition-colors duration-200"
                    >
                      Create Account
                    </button>
                  </div>
